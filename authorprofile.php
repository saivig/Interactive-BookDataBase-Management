  ...
  <div class="jumbotron">
     ...
     <?php
      ...
      $db = pg_connect("host=localhost dbname=Project user=postgres password=saivignan")
                        ...
                        $q="select authorname from bna where authorid='$authorid'";
                        $ret3 = pg_query($db, $q);
                        if(!$ret3){
                           echo pg_last_error($db);
                           exit;
                        } 
                       $authorname=pg_fetch_row($ret3);
      echo '<h2>'.$authorid.'</h2>';
      echo '<h2>'.$authorname[0].'</h2>';
      $q="select username";
      ?>
   </div>
  <div class="page-header">
        <h1>Other Books of Author</h1>
   </div>
        ...
        <div class="col-sm-4">
            <div class="list-group" id="sai">
              ...
              $db = pg_connect("host=localhost dbname=Project user=postgres password=saivignan")
                        ...
                        $sql ="select books2.isbn,books2.title from books2,bna where (bna.authorid='$authorid' and books2.isbn=bna.isbn) ;";
