        ...
        <div class="col-lg-4">
          <h2>Most Rated Books!</h2>
                      <?php
                        ...
                        $sql12 ="select isbn,avg(rats) as avrat from rat group by isbn order by avrat desc limit 7;";
                        $sql="select isbn,av_rats from topbooks_view limit 10";
     ...
     <div class="col-lg-4">
        <h2>Most popular authors</h2>
                    <?php
                       ...
                       $sql2="select authorid,authorname from topauthors_view limit 10";
              ...
              <div class="col-lg-4">
                  <h2>Most popular publishing house</h2>
                    <?php
                       $sql23 ="select authorid,authorname from BnA,(select isbn,avg(rats) as avrat from rat group by isbn order by avrat desc)as toprat 
                       where (toprat.isbn=BnA.ISBN )
                       limit 7; " ;
                       $sql3="select publication_house from toppublications_view limit 10";
